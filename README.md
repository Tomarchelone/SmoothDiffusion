...
### Note on Fast Matrix Prefix Products Computation 

The algorithm presented in the paper and used in this repository for fast parallel multiplication of ODE matrices is functionally equivalent to the parallel scan method (i.e., computing prefix products of an associative operator in parallel). For efficient implementation, please refer to the [torch_parallel_scan](https://github.com/glassroom/torch_parallel_scan) repository. I was unaware of this existing solution at the time of writing.
